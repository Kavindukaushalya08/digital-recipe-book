...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stats-banner { background: #f1f5f9; border-top: 1px solid #e2e8f0; padding: 50px 0; }
        .stats-grid { display: grid; grid-template-columns: repeat(4, 1fr); text-align: center; gap: 20px; }
        .stats-banner .stat-num { font-family: var(--font-heading); font-size: 2.5rem; font-weight: 800; color: #257838 !important; display: flex; align-items: center; justify-content: center; gap: 6px; margin-bottom: 6px; }
        .stats-banner .stat-label { font-size: 0.95rem; color: #64748b !important; font-weight: 600; }
    ...
    <section class="stats-banner">
        <div class="container">
            <div class="stats-grid">
                ...
                <div>
                    <span class="stat-num">4.9 <i class="fa-solid fa-star" style="font-size: 1.4rem; color: #ffb800;"></i></span>
